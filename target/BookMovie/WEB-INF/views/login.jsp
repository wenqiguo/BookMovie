...
<head>
    ...
    <link href="<%=basePath%>static/static/css/login.css" rel="stylesheet">

    <script></script>
    <title>沃美电影-登录注册</title>
</head>
<body>
    ...
    <div class="screen">
        ...
        <label class="title">沃 美 电 影</label><br/>
        <label class="ineer_one">新的视觉效果，心的视界盛宴</label><br/>
    </div>
    <!-- 登录页 -->
        ...
        <div class="page">
            ...
            <div class="childpage" style="display: block">
                ...
                <div class="login_page">
                    ...
                    <div>
                        <label>密码</label><br/>
                        <input id="LoginWord" type="password"/>
                    </div>
                </div>
                <div class="lo_error">
    ...
    　　}; 
        ...
        function TestNum(){
         ...
         //登录账号和密码信息验证
         function loginbtn(){
            var user_name = $(".login_page").find("#LoginUser").val();
            var user_pwd = $(".login_page").find("#LoginWord").val();
            ...
            if((user_name == "") || (user_pwd == "")){
                ...
                $.ajax({
                    ...
                    success: function(obj){
                        ...
                        if(obj.type == "errorUserName"){
                            alert(obj.msg);

                        }else if (obj.type=="errorPassword"){
                            alert(obj.msg)
                        }
                        else{
                            // 获取json对象user
