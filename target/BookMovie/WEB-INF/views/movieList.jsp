...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>static/static/css/movieList.css">
    ...
    <script>
        ...
        function initMovieList(){
            ...
            /*if(getUrlParams("type") == "全部" || getUrlParams("type") == null){
                $.ajax({
                    type: "post",
                    url: url + "/movie/findMoviesByKinds.do",
                    /!*分类*!/
                    data: {order: order},
                    dataType: "json",
                    success: function(obj){
                        ...
                        for(var i = 0;i < obj.data.length; i++){
                            ...
                            movielist.append(
                                "<li> <div class=\"movie-item\"> <a href=\"/order/ByTickets.do?movieId="+ obj.data[i].movieId +"\" target=\"_blank\"> <div class=\"movie-poster\"> <img src=\""+url+ obj.data[i].moviePicture +"\"> </div> </a>" +
                                    "<div class=\"channel-action channel-action-sale\"> <a>购票<a/> </div> <div class=\"movie-ver\"></div> </div>" +
                                    "<div class=\"channel-detail movie-item-title\" title=\""+ obj.data[i].movieCname +"\">" +
                                        "<a href=\"/movie/movieDetail.do?movieId=" + obj.data[i].movieId + "\" target=\"_blank\">"+ obj.data[i].movieCname +"</a> </div>" +
                ...
                $.ajax({
                    type: "post",
                    url: url + "/movie/findMoviesByType.do",
                    data: {type: type,
                           area:area,
                           year:year,
                    },
        ...
        function initTags(){
            ...
            var TypeStr = ["全部","爱情","喜剧","动画","剧情","惊悚","科幻","动作","悬疑","犯罪","冒险","运动","家庭","古装","其他"],
                AreaStr = ["全部","中国大陆","美国","印度","韩国","日本","中国香港","中国台湾","泰国","法国","英国","俄罗斯","意大利"],
                YearStr = ["全部","2020","2019","2018","2017","2016","2015"];
            var TypeActive = [],
                AreaActive = [],
                YearActive = [];
