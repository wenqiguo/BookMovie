...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/static/static/css/paystatus.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-paystatus">
            <img src="<%=basePath%>/static/static/images/success.jpg"/>
    ...
    <script>
        ...
        function returnCenter(){
            window.location.href = "/movie/center.do"
        }
